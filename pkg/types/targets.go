...
func GetTargetConfigManifest() *models.TargetConfigManifest {
	return &models.TargetConfigManifest{
		"Credential File": models.TargetConfigProperty{
		...
		"Project Id": models.TargetConfigProperty{
		...
		"Zone": models.TargetConfigProperty{
			Type: models.TargetConfigPropertyTypeString,
		...
		"Machine Type": models.TargetConfigProperty{
			Type: models.TargetConfigPropertyTypeString,
		...
		"Disk Type": models.TargetConfigProperty{
			Type: models.TargetConfigPropertyTypeString,
		...
		"VM Image": models.TargetConfigProperty{
			Type: models.TargetConfigPropertyTypeString,
...
func ParseTargetOptions(optionsJson string) (*TargetOptions, error) {
	...
	if targetOptions.WorkspaceID == "" {
		workspaceID, ok := os.LookupEnv("GCP_PROJECT_ID")
		if ok {
			targetOptions.WorkspaceID = workspaceID
		}
	}
	...
	if targetOptions.WorkspaceID == "" {
		return nil, fmt.Errorf("workspace id not set in env/target options")
	}
